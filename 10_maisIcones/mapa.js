...
function carregarMapa() {
    ...
    // Neste exercício são criados seis ícones, de acordo com a quantidade de cidades dos geossítios.
    ...
    let meuMapa = L.map('mapaLeaflet').setView([lugares[0].lat, lugares[0].long], 9);
    ...
    for (let i = 0; i < lugares.length; i++) {
        ...
        // Neste exercício, para cada cidade é associado um pino como marcador. 
        ...
        // O elemento <a> HTML é usado para criar links, entretanto, para linkar a URL ('site') dos geossítios é usado:
        // em vez de aspas '"', o sinal de crase '`'
        // e o objeto é referenciado com ${}
        // por exemplo:
        // `<a href='${objetoURL}'>`
        let geoparqueInfo = "<h2>" + lugares[i].nome + "</h2> Coordenadas: " + lugares[i].lat + ", " + lugares[i].long + "<br> Cidade: " + lugares[i].cidade + `<br> Site: <a href='${lugares[i].site}' target='blank'>` + lugares[i].site + "</a>";
